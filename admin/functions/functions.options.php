...
if (!function_exists('of_options'))
{
	function of_options()
	{
		...
		$bg_images_path = STYLESHEETPATH. 'assets/images/bg/'; // change this to where you store your bg images
		$bg_images_url = get_bloginfo('template_url').'/assets/images/bg/'; // change this to where you store your bg images
		$bg_images = array();
