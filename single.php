              ...
              <div class="row-fluid">
               ...
               <div class="android-slider hidden-phone span9 offset6">
                ...
                <div class="span5 profile">
                  <img src="<?php bloginfo('template_directory');?>/timthumb.php?src=<?php the_field('profile_image'); ?>&w=350&h=350&q=75" width="350" height="350" class="profile-img" />
            ...
            <div class="portfolio-items">
              <div class="row-fluid">
                ...
                <div class="portfolio-item span4">
                  <img src="<?php if(get_sub_field('portfolio_image')) { ?><?php bloginfo('template_directory');?>/timthumb.php?src=<?php the_sub_field('portfolio_image'); ?>&w=288&h=278&q=85<?php } else { echo theme_images() . 'portfolio-default.png'; } ?>" />                 
                </div> <!-- /portfolio-item -->
                <?php endwhile; ?>
